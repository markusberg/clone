...
exports['clone a Map'] = function (test) {
  var map = new Map()
  // simple key/value
  map.set('foo', 'bar')
...
exports['clone a Set'] = function (test) {
  var set = new Set()
  // simple entry
  set.add('foo')
  // circular entry
...
exports['clone a Promise that resolves to a value'] = function (test) {
  clone(Promise.resolve('foo')).then(function (value) {
    test.equal(value, 'foo')
    test.done()
  })
}
exports['clone a Promise that rejects to a value'] = function (test) {
  clone(Promise.reject('bar')).catch(function (value) {
    test.equal(value, 'bar')
    test.done()
  })
}
exports['clone a Promise that resolves to a Promise'] = function (test) {
  clone(Promise.resolve(Promise.resolve('baz'))).then(function (value) {
    test.equal(value, 'baz')
    test.done()
  })
}
exports['clone a Promise that resolves to a circular value'] = function (test) {
  var circle = {}
...
exports['clone a Promise with additional props'] = function (test) {
  ...
  clonedPromise.then(function (value) {
    test.equal(value, 'ok')
    test.done()
  })
}
...
exports['clone should ignore non-enumerable properties by default'] = function (
  test,
) {
  test.expect(5)
...
exports['clone should support cloning non-enumerable properties'] = function (
  test,
) {
  test.expect(6)
...
exports[
  'clone should allow enabling the cloning of non-enumerable properties via an options object'
] = function (test) {
  test.expect(1)
...
exports[
  'clone should mark the cloned non-enumerable properties as non-enumerable'
] = function (test) {
  test.expect(4)
  ...
  test.equal(Object.getOwnPropertyDescriptor(cloned, symbol1).enumerable, true)
  test.equal(Object.getOwnPropertyDescriptor(cloned, symbol2).enumerable, false)

  test.done()
}

exports[
  'clone should not fail when cloning an object that does not have setters defined on some of its properties'
] = function (test) {
  test.expect(1)
